...
namespace BLPin.BLL
{
	...
	/// StoryCommentBll
	/// </summary>
	public partial class StoryCommentBll
	{
		private readonly BLPin.DAL.StoryCommentDal dal=new BLPin.DAL.StoryCommentDal();
		public StoryCommentBll()
		{}
		#region  Method
		...
		/// 获得数据列表
		/// </summary>
		public List<BLPin.Model.StoryCommentModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BLPin.Model.StoryCommentModel> DataTableToList(DataTable dt)
		{
			List<BLPin.Model.StoryCommentModel> modelList = new List<BLPin.Model.StoryCommentModel>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BLPin.Model.StoryCommentModel model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new BLPin.Model.StoryCommentModel();
